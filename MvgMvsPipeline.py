...
CAMERA_SENSOR_DB_DIRECTORY = "/home/zhangxiaojie2017/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
    ...
    def __init__(self):
        self.steps_data = [
            ...
            ["Compute features",             # 1
             ...
             ["-i", "%matches_dir%/sfm_data.json", "-o", "%matches_dir%", "-m", "SIFT", "-n", "4", "-p", "ULTRA"]],
            ["Compute matches",              # 2
...
for cstep in CONF.steps:
    ...
    if not DEBUG:
        ...
        print('\t'.join(cmdline))
    time_file["timeList"][inx]["reconstruction steps"][STEPS[cstep].info] = time.time() - startTime
